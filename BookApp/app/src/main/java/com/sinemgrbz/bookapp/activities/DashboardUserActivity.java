...
import com.sinemgrbz.bookapp.BooksUserFragment;
import com.sinemgrbz.bookapp.databinding.ActivityDashboardUserBinding;
    ...
    private void setupViewPagerAdapter(ViewPager viewPager){
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ModelCategory modelAll=new ModelCategory("01","Tüm Kitaplar","",1);
                ModelCategory modelMostViewed=new ModelCategory("02","En çok Görüntülenen","",1);
                ModelCategory modelMostDownloaded=new ModelCategory("03","En çok indirilenler","",1);
